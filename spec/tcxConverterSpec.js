...
describe("Tcx2Converter", function() {
    ...
    it("should convert Fitbit tcx data correctly", function(done) {
        ...
        .catch(function (e) {
            fail("Failed to convert Fitbit TCX XML to JSON.")
            done()
        })
    })
    ...
    it("should convert Garmin tcx data correctly", function(done) {
        ...
        .catch(function (e) {
            fail("Failed to convert Garmin TCX XML to JSON.")
            done()
        })
    })

    it("should convert Tcx data with only one lap correctly", function(done) {
        ...
        .catch(function (e) {
            fail("Failed to convert Fitbit TCX XML with only one lap to JSON.")
            done()
        })
    })
})